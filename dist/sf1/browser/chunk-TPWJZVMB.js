import{a as E}from"./chunk-UUWVPWNW.js";import{i as X,j as Y}from"./chunk-O24ZBYRE.js";import"./chunk-H5PHOR7K.js";import{a as Q,b as W}from"./chunk-HB5MJUZ7.js";import{f as V,g as H,h as q,i as G}from"./chunk-6HJXQQ52.js";import{fa as b,ha as J,ja as K}from"./chunk-NHLDXA6S.js";import{h as U,j as O,n as P}from"./chunk-H4C6DTRU.js";import{$,Db as u,Eb as c,Fb as B,Gb as N,Ka as j,Ma as m,Nb as k,O as S,Ob as l,P as z,Pb as g,U as d,Vb as v,Ya as f,Za as D,_ as L,ab as M,ca as y,cb as x,gc as w,ia as R,ib as _,jb as s,lb as A,mb as F,nb as C,tb as a,ub as r,vb as n,zb as T}from"./chunk-PNFXW432.js";import"./chunk-EQDQRRRY.js";var re=["*"];function ae(e,p){if(e&1&&(a(0,"span",3),l(1),r()),e&2){let t=c();m(),g(t.label)}}function ne(e,p){if(e&1&&n(0,"span",5),e&2){let t=c(2);C(t.icon),s("ngClass","p-avatar-icon")}}function ie(e,p){if(e&1&&x(0,ne,1,3,"span",4),e&2){let t=c(),i=k(5);s("ngIf",t.icon)("ngIfElse",i)}}function oe(e,p){if(e&1){let t=T();a(0,"img",7),u("error",function(o){L(t);let h=c(2);return $(h.imageError(o))}),r()}if(e&2){let t=c(2);s("src",t.image,j),_("aria-label",t.ariaLabel)}}function le(e,p){if(e&1&&x(0,oe,1,2,"img",6),e&2){let t=c();s("ngIf",t.image)}}var se=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
