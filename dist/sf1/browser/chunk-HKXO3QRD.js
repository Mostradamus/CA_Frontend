import{a as E}from"./chunk-MCJE7WKQ.js";import{i as X,j as Y}from"./chunk-J5MJUPFL.js";import"./chunk-D5LKKY34.js";import{a as Q,b as W}from"./chunk-2UONUHI4.js";import{f as V,g as H,h as q,i as G}from"./chunk-F4ZLJDT5.js";import{fa as b,ha as J,ja as K}from"./chunk-B3P2FQNP.js";import{$,$a as M,Ab as u,Bb as c,Bc as O,Cb as B,Db as N,Fc as P,Ka as j,Kb as k,Lb as l,Ma as m,Mb as g,O as S,P as z,Sb as v,U as d,Ya as f,Za as D,_ as L,bb as x,ca as y,dc as w,hb as _,ia as R,ib as s,kb as A,lb as F,mb as C,sb as a,tb as r,ub as n,yb as T,zc as U}from"./chunk-JBQC2IQB.js";import"./chunk-EQDQRRRY.js";var re=["*"];function ae(e,p){if(e&1&&(a(0,"span",3),l(1),r()),e&2){let t=c();m(),g(t.label)}}function ne(e,p){if(e&1&&n(0,"span",5),e&2){let t=c(2);C(t.icon),s("ngClass","p-avatar-icon")}}function ie(e,p){if(e&1&&x(0,ne,1,3,"span",4),e&2){let t=c(),i=k(5);s("ngIf",t.icon)("ngIfElse",i)}}function oe(e,p){if(e&1){let t=T();a(0,"img",7),u("error",function(o){L(t);let h=c(2);return $(h.imageError(o))}),r()}if(e&2){let t=c(2);s("src",t.image,j),_("aria-label",t.ariaLabel)}}function le(e,p){if(e&1&&x(0,oe,1,2,"img",6),e&2){let t=c();s("ngIf",t.image)}}var se=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
